...
for i = 1:n
    ...
    a2=a*max(cell_types2_0)
    [max_cell_types_2, cell_types2_0, signal_pathway] = signal_transduction(cell_types2_0, X2, a2, i, 1, signal_pathway);
    ...
    a3=a*max(cell_types3_0)
    [max_cell_types_3, cell_types3_0, signal_pathway] = signal_transduction(cell_types3_0, X3, a3, i, 2, signal_pathway);
    ...
    a4=a*max(cell_types4_0)
    [max_cell_types_4, cell_types4_0, signal_pathway] = signal_transduction(cell_types4_0, X4, a4, i, 3, signal_pathway);
    ...
    a6=a*max(cell_types6_0)
    [max_cell_types_6, cell_types6_0, signal_pathway] = signal_transduction(cell_types6_0, X6, a6, i, 4, signal_pathway);
    ...
    a7=a*max(cell_types7_0)
    [max_cell_types_7, cell_types7_0, signal_pathway] = signal_transduction(cell_types7_0, X7, a7, i, 5, signal_pathway);
    ...
    a8=a*max(cell_types8_0)
    [max_cell_types_8, cell_types8_0, signal_pathway] = signal_transduction(cell_types8_0, X8, a8, i, 6, signal_pathway);
    ...
    a12=a*max(cell_types12_0)
    [max_cell_types_12, cell_types12_0, signal_pathway] = signal_transduction(cell_types12_0, X12, a12, i, 7, signal_pathway);
...
for i=1:n
    ...
    for m=1:7
    L = length(DATA{i, m});
B(i,xx:xx+L-1)=cell2mat(DATA(i,m));
xx=xx+L;
end
end
