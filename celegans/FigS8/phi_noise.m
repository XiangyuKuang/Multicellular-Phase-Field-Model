...
SimNum = 10;
noise = 5;
DefaultSimParameters.phinoise = noise;
for SimIdx = 1:SimNum
  SimName = sprintf('phin%s_%d',dot2d(noise),SimIdx);
  SimStageEnd = StageEnd;
  mainBDF2VC_phinoise(SimName,L,N,dt,SimIdx,DefaultSimParameters,CellParameters,SimStageEnd,tspan,...
