...
StageEnd(8).SimParaModify = struct('ParaName','sigma','ParaValue',[sigma1,sigma2],'Motif',{{}},'Noise',0);
...
for SimIdx = 1:SimNum
  SimName = sprintf('8adhto12dx%sdt%sc18sigma%s-%s_3',dot2d(dx),dot2d(dt),dot2d(sigma1),dot2d(sigma2));
  SimStageEnd = StageEnd;
  SimStageEnd(9).SimParaModify.Motif = {{'MS','E'},sigma1;};
