...
S1 = 12;
S2 = 0;
noiseValue = sqrt(0.05);
ICDirName = 'N400r5dx0d5_1';
CellParaName = '200200';
DefaultSimParameters.noise = noiseValue;
DefaultSimParameters.sigma = [0.9,0.4; 0.4,0.9;];
SimName = sprintf('Asymdt%sCT1_%s_2',dot2d(dt),CellParaName);
load(sprintf('%s/CellParameters_%s_1.mat',ICDirName,CellParaName))
